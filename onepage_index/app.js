...
typewriter
  .pauseFor(1800)
  .changeDelay(20)
  .typeString(`Je suis Audifax Moumpossa`)
  .pauseFor(300)
  .typeString('<strong>, Développeur Intégrateur</strong> !')
  .pauseFor(1000)
  .deleteChars(13)
...
let monTitre = document.querySelector('#monTitre');
let compteur = 0;
function print() {
  console.log(compteur);
  if (compteur == 0) {
    monTitre.textContent = 'Bienvenue';
    compteur++;
  } else if (compteur == 1) {
    monTitre.textContent = monTitre.textContent + ' dans';
    compteur++;
  } else if (compteur == 2) {
    monTitre.textContent = monTitre.textContent + ' mon';
    compteur++;
  } else if (compteur == 3) {
    monTitre.textContent = ' univers';
    compteur++;
  } else if (compteur == 4) {
    monTitre.textContent = `Vous pouvez me contacter`;
    compteur++;
  } else {
